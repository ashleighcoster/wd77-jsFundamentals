...
//loops can run infinitely (they are bugs)
// for (let i = 0; ; i++){
//     console.log(i);
// }
...
//[] = can use 'kinkade' as an array - positions 0-6 starting with K 
let name = 'Kinkade';
...
//'math' - built in js object with a random method that produces a number between 0 and 1 
let start = 2; 
